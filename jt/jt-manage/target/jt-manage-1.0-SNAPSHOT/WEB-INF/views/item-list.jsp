    ...
    var toolbar = [{
        ...
        handler:function(){
        	...
        	$("#itemEditWindow").window({
        		onLoad :function(){
        			...
        			//将给定的对象在form表单中进行回显.根据name属性进行回显.
        			//UI框架提供了关于form表单操作的方式. load表示加载.
                   ...
                   */
                    ...
                    $.get("/item/cat/queryItemName",{"itemCatId":cid},
                        function(data){     //data 代表返回值结果 name名称
                           $("#itemeEditForm input[name='cid']")
                                .prev("span")
                                .text(data);
                    })
        ...
        handler:function(){
        	...
        	$.messager.confirm('确认','确定删除ID为 '+ids+' 的商品吗？',function(r){
        	    if (r){
        	    	var params = {"ids":ids};   //101,102,103
